 ...
 */
open class IngredientSpeedometer @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : Speedometer(context, attrs, defStyleAttr) {
    ...
    private val _startDegree = 125
    private val _endDegree = 450
    private val _overloadDegree = 415  // 89.23%
...
//                speedBackgroundPaint.maskFilter = null
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        while (i < getEndDegree()) {
            ...
            } else if (degree <= i && i >_overloadDegree) {
